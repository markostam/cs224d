...
class StanfordSentiment:
    ...
    def sent_labels(self):
        ...
        for i in range(self.numSentences()):
            try:
                sentence = [j.decode('utf-8') for j in sentences[i]] #grab a sentence and decode it from bytes
            except:
                pass
                #print("{} is not a valid utf-8 sentence".format([j.decode('latin1') for j in sentences[i]]))
